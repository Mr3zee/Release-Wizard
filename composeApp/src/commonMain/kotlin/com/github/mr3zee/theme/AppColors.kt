...
val LightAppColors = AppColors(
    ...
    gateIndicator = Color(0xFF0EA5E9),
    gateIndicatorPost = Color(0xFFF59E0B),
...
val DarkAppColors = AppColors(
    ...
    gateIndicator = Color(0xFF38BDF8),
    gateIndicatorPost = Color(0xFFFBBF24),
